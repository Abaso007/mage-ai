...
class File:
    ...
    @classmethod
    def from_path(cls, file_path, repo_path=None):
        repo_path = repo_path or get_repo_path()
    ...
    def write(cls, repo_path: str, dir_path: str, filename: str, content: str, create_directories_if_not_exist: bool = True, file_version_only: bool = False, overwrite: bool = True) -> None:
        for file_path, write_type, content in cls.write_preprocess(repo_path, dir_path, filename, content, create_directories_if_not_exist=create_directories_if_not_exist, file_version_only=file_version_only, overwrite=overwrite):
